...
function printEmployeeDTR() {
  ...
  w.document.write('.page{width:380px;margin:0 auto;padding:20px 16px;border:1px solid #000}');
  ...
  w.document.write('@media print{.page{border:none;padding:10px 8px}body{margin:0}}');
  w.document.write('</style></head><body>');
